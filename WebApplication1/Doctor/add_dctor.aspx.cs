...
{
    public partial class add_dctor : System.Web.UI.Page
    {
        ...
        void LoadDoctorData()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT id, name1, d_username, d_password FROM doctor_login_tbl WHERE id LIKE 'd0%'", con);
